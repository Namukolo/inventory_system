...
class Product {
  ...
  removeStock(numOfItems, buyerEmail) {
    if (buyersRecords.includes(buyerEmail)) {
...
const product1 = new Product(001, 12, [23, 56]);
const product2 = new Product(002, 32, [200, 156, 250, 180]);
const product3 = new Product(003, 90, [3, 8, 10, 7]);
